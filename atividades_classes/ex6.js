...
iii. Caso a função responda false o programa diz que não é possível desligar um carro em movimento.
Caso o usuário escolha uma opção que não existe o algoritmo simplesmente diz que não entendeu e solicita de novo as 3 opções.
Caso o usuário escolha uma opção válida o programa após imprimir o valor da velocidade deve novamente repetir a escolha 
das 3 opções para o usuário. Para isso no módulo Carro (carro.js que criamos na atividade 5) no construtor adicione
uma propriedade no objeto chamada velocidade e inicie o valor dela com 0 Adicione também 3 funções
d. Acelerar
...
e. Frear
i. Toda vida que esta função for executada deve diminuir o valor da propriedade da velocidade em 5
